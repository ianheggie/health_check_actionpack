...
Gem::Specification.new do |spec|
  spec.name          = "health_check_actionpack"
  spec.version       = HealthCheckActionpack::VERSION
  spec.authors       = ["Ian Heggie"]
  spec.email         = ["ian@heggie.biz"]

  spec.summary       = %q{Simple health check Rails url for uptime monitoring with Pingdom, NewRelic, EngineYard or uptime.openacs.org etc}
  spec.description   = %q{This plugin is part of the Health Check v2 suite - See HealthCheck2 for further details}
  spec.homepage      = "https://github.com/ianheggie/health_check_actionpack"
  spec.license       = "MIT"
